...
- Name: 01-trips.spec.js >> Fisherman · Trips >> Alert Vendors button — counts unalerted catches and disables after alerting
- Location: tests\e2e\01-trips.spec.js:109:3
...
Locator: getByRole('button', { name: /alert vendors \(2\)/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /alert vendors \(2\)/i })
